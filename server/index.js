...
import { registerDailyRewardRoutes } from './dailyRewards.js';
...
const dailyRewardRateLimit = buildRateLimiter({
  windowMs: 60 * 1000,
  max: 20,
  message: { error: 'Too many daily reward requests — please wait a moment and try again.' },
  store: sharedRateLimitStore,
});
